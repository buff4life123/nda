 ...
 */
final class Version20190312211247 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE banner_translation ADD locales_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_841ECF1C164006B8 ON banner_translation (locales_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_841ECF1C164006B8 ON banner_translation');
        $this->addSql('ALTER TABLE banner_translation DROP locales_id');
