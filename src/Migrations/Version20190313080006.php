 ...
 */
final class Version20190313080006 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE banner ADD text_active TINYINT(1) DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE banner DROP text_active');
