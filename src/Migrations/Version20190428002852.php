 ...
 */
final class Version20190428002852 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company ADD address2 VARCHAR(50) NOT NULL, ADD p_code2 VARCHAR(10) NOT NULL, ADD city2 VARCHAR(10) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company DROP address2, DROP p_code2, DROP city2');
