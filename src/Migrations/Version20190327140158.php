 ...
 */
final class Version20190327140158 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu CHANGE link_active is_active TINYINT(1) DEFAULT \'0\' NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE menu CHANGE is_active link_active TINYINT(1) DEFAULT \'0\' NOT NULL');
    }
}
