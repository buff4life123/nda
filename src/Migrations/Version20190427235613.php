 ...
 */
final class Version20190427235613 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company ADD email2 VARCHAR(30) NOT NULL, ADD email3 VARCHAR(30) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company DROP email2, DROP email3');
